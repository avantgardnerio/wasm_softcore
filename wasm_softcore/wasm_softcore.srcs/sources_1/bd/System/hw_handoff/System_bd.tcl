...
proc create_root_design { parentCell } {
  ...
  # Create instance: wasm_softcore_0, and set properties
  set block_name wasm_softcore
  set block_cell_name wasm_softcore_0
  if { [catch {set wasm_softcore_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $wasm_softcore_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins wasm_softcore_0/S_AXI]

  # Create port connections
  connect_bd_net -net blk_mem_gen_0_douta [get_bd_pins blk_mem_gen_0/douta] [get_bd_pins wasm_softcore_0/douta]
  connect_bd_net -net blk_mem_gen_0_rsta_busy [get_bd_pins blk_mem_gen_0/rsta_busy] [get_bd_pins wasm_softcore_0/rsta_busy]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins wasm_softcore_0/S_AXI_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins wasm_softcore_0/S_AXI_ARESETN]
  connect_bd_net -net wasm_softcore_0_addra [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins wasm_softcore_0/addra]
  connect_bd_net -net wasm_softcore_0_clka [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins wasm_softcore_0/clka]
  connect_bd_net -net wasm_softcore_0_dina [get_bd_pins blk_mem_gen_0/dina] [get_bd_pins wasm_softcore_0/dina]
  connect_bd_net -net wasm_softcore_0_ena [get_bd_pins blk_mem_gen_0/ena] [get_bd_pins wasm_softcore_0/ena]
  connect_bd_net -net wasm_softcore_0_rsta [get_bd_pins blk_mem_gen_0/rsta] [get_bd_pins wasm_softcore_0/rsta]
  connect_bd_net -net wasm_softcore_0_wea [get_bd_pins blk_mem_gen_0/wea] [get_bd_pins wasm_softcore_0/wea]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs wasm_softcore_0/S_AXI/reg0] SEG_wasm_softcore_0_reg0
